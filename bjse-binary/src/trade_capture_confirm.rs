...
use crate::trade_capture_confirm_extend_031::*;
use crate::trade_capture_confirm_extend_051::*;
use crate::trade_capture_confirm_extend_060::*;
use crate::trade_capture_confirm_extend_061::*;
use crate::trade_capture_confirm_extend_062::*;

#[derive(Debug, Clone, PartialEq)]
pub enum TradeCaptureConfirmApplExtendEnum {
    TradeCaptureConfirmExtend031(TradeCaptureConfirmExtend031),
    TradeCaptureConfirmExtend051(TradeCaptureConfirmExtend051),
    TradeCaptureConfirmExtend060(TradeCaptureConfirmExtend060),
    TradeCaptureConfirmExtend061(TradeCaptureConfirmExtend061),
    TradeCaptureConfirmExtend062(TradeCaptureConfirmExtend062),
}

#[derive(Debug, Clone, PartialEq)]
pub struct TradeCaptureConfirm {
    ...
    pub appl_extend: TradeCaptureConfirmApplExtendEnum,
}

impl BinaryCodec for TradeCaptureConfirm {
    fn encode(&self, buf: &mut BytesMut) {
        ...
        match &self.appl_extend {
            TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend031(msg) => msg.encode(buf),
            TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend051(msg) => msg.encode(buf),
            TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend060(msg) => msg.encode(buf),
            TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend061(msg) => msg.encode(buf),
            TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend062(msg) => msg.encode(buf),
        }
    }

    fn decode(buf: &mut Bytes) -> Option<TradeCaptureConfirm> {
        ...
        let appl_extend = match appl_id.as_str() {
            "031" => TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend031(
                TradeCaptureConfirmExtend031::decode(buf)?,
            ),
            "051" => TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend051(
                TradeCaptureConfirmExtend051::decode(buf)?,
            ),
            "060" => TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend060(
                TradeCaptureConfirmExtend060::decode(buf)?,
            ),
            "061" => TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend061(
                TradeCaptureConfirmExtend061::decode(buf)?,
            ),
            "062" => TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend062(
                TradeCaptureConfirmExtend062::decode(buf)?,
            ),
            _ => return None,
        };
        Some(Self {
...
#[cfg(test)]
mod trade_capture_confirm_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_trade_capture_confirm_codec() {
        let original = TradeCaptureConfirm {
            partition_no: -123456,
            ...
            appl_extend: TradeCaptureConfirmApplExtendEnum::TradeCaptureConfirmExtend031(
                TradeCaptureConfirmExtend031 {
        ...
        let decoded = TradeCaptureConfirm::decode(&mut bytes).unwrap();
