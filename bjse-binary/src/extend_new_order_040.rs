...
impl BinaryCodec for ExtendNewOrder040 {
    ...
    fn decode(buf: &mut Bytes) -> Option<ExtendNewOrder040> {
...
#[cfg(test)]
mod extend_new_order_040_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_new_order_040_codec() {
        let original = ExtendNewOrder040 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = ExtendNewOrder040::decode(&mut bytes).unwrap();
