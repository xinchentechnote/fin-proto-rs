...
pub struct TradeCaptureReportAckExtend031 {
...
impl BinaryCodec for TradeCaptureReportAckExtend031 {
    ...
    fn decode(buf: &mut Bytes) -> Option<TradeCaptureReportAckExtend031> {
...
#[cfg(test)]
mod trade_capture_report_ack_extend_031_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_trade_capture_report_ack_extend_031_codec() {
        let original = TradeCaptureReportAckExtend031 {
        ...
        let decoded = TradeCaptureReportAckExtend031::decode(&mut bytes).unwrap();
