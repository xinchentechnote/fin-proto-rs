...
pub struct TradeCaptureReportExtend051 {
    pub expiration_days: u16,
    pub expiration_type: u8,
    pub share_property: String,
}

impl BinaryCodec for TradeCaptureReportExtend051 {
    ...
    fn decode(buf: &mut Bytes) -> Option<TradeCaptureReportExtend051> {
...
#[cfg(test)]
mod trade_capture_report_extend_051_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_trade_capture_report_extend_051_codec() {
        let original = TradeCaptureReportExtend051 {
        ...
        let decoded = TradeCaptureReportExtend051::decode(&mut bytes).unwrap();
