...
impl BinaryCodec for ExtendNewOrder010 {
    ...
    fn decode(buf: &mut Bytes) -> Option<ExtendNewOrder010> {
...
#[cfg(test)]
mod extend_new_order_010_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_new_order_010_codec() {
        let original = ExtendNewOrder010 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = ExtendNewOrder010::decode(&mut bytes).unwrap();
