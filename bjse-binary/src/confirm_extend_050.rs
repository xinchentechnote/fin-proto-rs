...
impl BinaryCodec for ConfirmExtend050 {
    ...
    fn decode(buf: &mut Bytes) -> Option<ConfirmExtend050> {
...
#[cfg(test)]
mod confirm_extend_050_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_confirm_extend_050_codec() {
        let original = ConfirmExtend050 {
        ...
        let decoded = ConfirmExtend050::decode(&mut bytes).unwrap();
