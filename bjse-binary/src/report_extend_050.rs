...
impl BinaryCodec for ReportExtend050 {
    ...
    fn decode(buf: &mut Bytes) -> Option<ReportExtend050> {
...
#[cfg(test)]
mod report_extend_050_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_report_extend_050_codec() {
        let original = ReportExtend050 {
        ...
        let decoded = ReportExtend050::decode(&mut bytes).unwrap();
