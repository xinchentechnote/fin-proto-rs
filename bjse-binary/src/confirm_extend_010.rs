...
impl BinaryCodec for ConfirmExtend010 {
    ...
    fn decode(buf: &mut Bytes) -> Option<ConfirmExtend010> {
...
#[cfg(test)]
mod confirm_extend_010_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_confirm_extend_010_codec() {
        let original = ConfirmExtend010 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = ConfirmExtend010::decode(&mut bytes).unwrap();
