...
impl BinaryCodec for Extend200715 {
    ...
    fn decode(buf: &mut Bytes) -> Option<Extend200715> {
...
#[cfg(test)]
mod extend_200715_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_200715_codec() {
        let original = Extend200715 {
        ...
        let decoded = Extend200715::decode(&mut bytes).unwrap();
