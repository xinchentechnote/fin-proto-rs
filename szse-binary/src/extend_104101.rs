...
impl BinaryCodec for Extend104101 {
    ...
    fn decode(buf: &mut Bytes) -> Option<Extend104101> {
...
#[cfg(test)]
mod extend_104101_tests {
    use super::*;

    use bytes::BytesMut;

    #[test]
    fn test_extend_104101_codec() {
        let original = Extend104101 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = Extend104101::decode(&mut bytes).unwrap();
