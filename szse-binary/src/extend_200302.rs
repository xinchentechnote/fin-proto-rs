...
impl BinaryCodec for Extend200302 {
    ...
    fn decode(buf: &mut Bytes) -> Option<Extend200302> {
...
#[cfg(test)]
mod extend_200302_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_200302_codec() {
        let original = Extend200302 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = Extend200302::decode(&mut bytes).unwrap();
