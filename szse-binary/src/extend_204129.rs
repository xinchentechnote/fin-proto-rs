...
impl BinaryCodec for Extend204129 {
    ...
    fn decode(buf: &mut Bytes) -> Option<Extend204129> {
...
#[cfg(test)]
mod extend_204129_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_204129_codec() {
        let original = Extend204129 {
        ...
        let decoded = Extend204129::decode(&mut bytes).unwrap();
