...
impl BinaryCodec for Extend101401 {
    ...
    fn decode(buf: &mut Bytes) -> Option<Extend101401> {
...
#[cfg(test)]
mod extend_101401_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_101401_codec() {
        let original = Extend101401 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = Extend101401::decode(&mut bytes).unwrap();
