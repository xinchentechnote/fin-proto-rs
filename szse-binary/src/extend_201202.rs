...
impl BinaryCodec for Extend201202 {
    fn encode(&self, buf: &mut BytesMut) {
        ...
        buf.put_i64(self.subst_cash);
    }

    fn decode(buf: &mut Bytes) -> Option<Extend201202> {
...
#[cfg(test)]
mod extend_201202_tests {
    use super::*;

    use bytes::BytesMut;

    #[test]
    fn test_extend_201202_codec() {
        let original = Extend201202 {
        ...
        let decoded = Extend201202::decode(&mut bytes).unwrap();
