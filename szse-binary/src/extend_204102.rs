...
impl BinaryCodec for Extend204102 {
    ...
    fn decode(buf: &mut Bytes) -> Option<Extend204102> {
...
#[cfg(test)]
mod extend_204102_tests {
    use super::*;
    use bytes::BytesMut;

    #[test]
    fn test_extend_204102_codec() {
        let original = Extend204102 {
            stop_px: -123456789,
            min_qty: -123456789,
        ...
        let decoded = Extend204102::decode(&mut bytes).unwrap();
